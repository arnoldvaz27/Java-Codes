			...
			{	
				...
				if(choose.equals("1") || choose.equals("caprese salad"))
				{
					System.out.println("  CAPRESE SALAD");
						System.out.println("*************************************");
						System.out.println("1. EXTRA TOMATO - RS. 20/-");
						System.out.println("2. EXTRA MOZZARELLA CHEESE - RS. 25/-");
						System.out.println("3. PESTO SAUCE - RS. 20/-");
				...
				else if(choose.equals("2") || choose.equals("panazella"))
				{
					System.out.println("----PANAZELLA");
						System.out.println("*************************************");
						System.out.println("1. EXTRA VEGGIES - RS. 10/-");
						System.out.println("2. EXTRA HERBS - RS. 10/-");
						System.out.println("3. EXTRA BREAD - RS. 10/-");
					System.out.print("ENTER THE EXTRA ITEM YOU REQUIRED WITH THE DISH: ");
					type1=scr.nextInt();
					switch(type1)
					{
				...
				else if(choose.equals("3") || choose.equals("brushchetta"))
				{
					System.out.println("----BRUSHCHETTA");
						System.out.println("*************************************");
						System.out.println("1. EXTRA VEGGIES - RS. 10/-");
						System.out.println("2. EXTRA MUSHROOM GARLIC - RS. 15/-");
						System.out.println("3. EXTRA TOMATO-BASIL - RS. 10/-");
					System.out.print("ENTER THE EXTRA ITEM YOU REQUIRED WITH THE DISH: ");
					type1=scr.nextInt();
					switch(type1)
					{
				...
				else if(choose.equals("4") || choose.equals("focaccia bread"))
				{
					System.out.println("----FOCACCIA BREAD");
						System.out.println("*************************************");
						System.out.println("1. EXTRA CARAMELIZED OLIVES - RS. 30/-");
						System.out.println("2. EXTRA GRATED PARMESAN CHESSE - RS. 30/-");
						System.out.println("3. EXTRA BASIL LEAVES - RS. 5/-");
					System.out.print("ENTER THE EXTRA ITEM YOU REQUIRED WITH THE DISH: ");
					type1=scr.nextInt();
					switch(type1)
					{
				...
				else if(choose.equals("5") || choose.equals("pasta"))
				{
					System.out.println("----PASTA");
						System.out.println("*************************************");
						System.out.println("1. EXTRA PIG'S CHEEK - RS. 25/-");
					System.out.print("ENTER THE EXTRA ITEM YOU REQUIRED WITH THE DISH: ");
					type1=scr.nextInt();
					switch(type1)
					{
				...
				else if(choose.equals("6") || choose.equals("pizza"))
				{
					System.out.println("----PIZZA");
						System.out.println("*************************************");
						System.out.println("1. EXTRA MOZZARELLA CHESSE - RS. 15/-");
						System.out.println("2. EXTRA TOMATO AND BASIL - RS. 10/-");
						System.out.println("3. EXTRA SPICY - RS. 10/-");
					System.out.print("ENTER THE EXTRA ITEM YOU REQUIRED WITH THE DISH: ");
					type1=scr.nextInt();
					switch(type1)
					{
				...
				else if(choose.equals("7") || choose.equals("risotto"))
				{
					System.out.println("----RISOTTO");
						System.out.println("*************************************");
						System.out.println("1. EXTRA MUSHROOM - RS. 30/-");
						System.out.println("2. EXTRA BUTTER - RS. 20/-");
					System.out.print("ENTER THE EXTRA ITEM YOU REQUIRED WITH THE DISH: ");
					type1=scr.nextInt();
					switch(type1)
					{
				...
				else if(choose.equals("8") || choose.equals("lasagna"))
				{
					System.out.println("----LASAGNA");
						System.out.println("*************************************");
						System.out.println("1. EXTRA LAMB - RS. 30/-");
						System.out.println("2. EXTRA VEGGIES - RS. 10/-");
						System.out.println("3. VERY CHESSE - RS. 10/-");
					System.out.print("ENTER THE EXTRA ITEM YOU REQUIRED WITH THE DISH: ");
					type1=scr.nextInt();
					switch(type1)
					{
				...
				else if(choose.equals("9") || choose.equals("tiramisu")) 
				{
					System.out.println("----TIRAMISU");
						System.out.println("*************************************");
						System.out.println("1. EXTRA CREAM - RS. 15/-");
						System.out.println("2. EXTRA LAYER - RS. 10/-");
					System.out.print("ENTER THE EXTRA ITEM YOU REQUIRED WITH THE DISH: ");
					type1=scr.nextInt();
					switch(type1)
					{
